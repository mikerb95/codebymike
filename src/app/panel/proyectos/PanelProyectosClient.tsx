...
export function PanelProyectosClient() {
    ...
    <div className="min-h-dvh pt-28 pb-32 px-6 mx-auto max-w-6xl">
      <div className="flex items-start justify-between gap-6 flex-wrap">
        ...
        <div className="flex items-center gap-4">
          ...
          <form action={async () => { const { logout } = await import('../login/actions'); await logout() }}>
            <button type="submit" className="text-xs font-medium text-slate-500 hover:text-red-600 dark:hover:text-red-400">Cerrar sesión</button>
          </form>
        </div>
      </div>
